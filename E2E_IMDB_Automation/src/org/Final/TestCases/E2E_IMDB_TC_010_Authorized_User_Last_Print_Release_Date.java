...
public class E2E_IMDB_TC_010_Authorized_User_Last_Print_Release_Date extends InitiateDriver {
	
	@Test
	public void athorizedUser_Print_ReleaseDate() throws InterruptedException {
	...
	jse.executeScript("window.scrollBy(0,13000)");
	String heading = driver.findElement(By.xpath(PropertyReader.elementLocatorReader("Release_date_for_the_console_xpath"))).getText();
	System.out.println("Test Case-10 Passed");
	System.out.println("The Release date of the last Movie was "+heading);
